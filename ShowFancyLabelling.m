...
plot(x,y)
axis equal off
HA= 'HorizontalAlignment';      % HA 表示水平对齐
VA= 'VerticalAlignment';     % VA 表示垂直对齐
text(x(1),y(1),'\leftarrow{\itP}_{1}', ...
                     HA, 'left','FontSize', 14)
text(x(2),y(2),'\downarrow', ...
                     HA, 'center', VA,'baseline', 'FontSize', 14)
text(x(2),y(2),' {\itP}_{2}', ...
                     HA, 'left', VA,'baseline', 'FontSize', 14)
text(x(3),y(3),'{\itP}_{3}\rightarrow', ...
                     HA, 'right', 'FontSize', 14)
text(x(4),y(4),'{\itP}_{4}\rightarrow', ...
                     HA, 'right', 'FontSize', 14)
...
text(x(6),y(6),'\leftarrow {\itP}_{6}', ...
                     HA, 'left', 'FontSize', 14)
text(0, .4*r, 'A Labelled Hexagon^{1}', ...
                     HA, 'center', 'FontSize',14)
text(0, -.4*r, '^{1} A hexagon has six sides.', ...
